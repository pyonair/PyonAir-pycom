...
def get_html_form():
    if config.get_config("PM1"):
        PM1_state = "checked"
    else:
        PM1_state = ""
    if config.get_config("PM2"):
        PM2_state = "checked"
    else:
        PM2_state = ""
    if config.get_config("TEMP"):
        TEMP_state = "checked"
    else:
        TEMP_state = ""
    if config.get_config("GPS"):
        GPS_state = "checked"
    else:
        GPS_state = ""
    ...
    <html>
        ...
        <body>
              ...
              <form class="config_form">
                ...
                <label class="config_form_label">Device ID: ''' + str(config.get_config("device_id")) + '''</label>
                <br>
                <label class="config_form_label" for="device_name">Device Name</label>
                <input class="config_form_input_text" id="device_name" name="device_name" type="text" value="''' + str(config.get_config("device_name")) + '''" required="required" maxlength="32"/>
                <label class="config_form_label" for="password">New Password</label>
                <input class="config_form_input_text" id="password" name="password" type="password" value="''' + str(config.get_config("password")) + '''" required="required" maxlength="32"/>
                <p class="heading">LoRaWAN Configuration:</p>
                <label class="config_form_label">Device EUI: ''' + str(config.get_config("device_eui")) + '''</label>
                <br>
                <label class="config_form_label" for="region">Region</label>
                <input class="config_form_input_text" id="region" name="region" type="text" value="''' + str(config.get_config("region")) + '''" required="required" maxlength="32"/>
                <label class="config_form_label" for="application_eui">Application EUI</label>
                <input class="config_form_input_text" id="application_eui" name="application_eui" type="text" value="''' + str(config.get_config("application_eui")) + '''" required="required" maxlength="16"/>
                <label class="config_form_label" for="app_key">App Key</label>
                <input class="config_form_input_text" id="app_key" name="app_key" type="password" value="''' + str(config.get_config("app_key")) + '''" required="required" maxlength="32"/>
                <p class="heading">MQTT Configuration:</p>
                <label class="config_form_label" for="application_id">Application ID</label>
                <input class="config_form_input_text" id="application_id" name="application_id" type="text" value="''' + str(config.get_config("application_id")) + '''" required="required" maxlength="32"/>
                <label class="config_form_label" for="access_key">Access Key</label>
                <input class="config_form_input_text" id="access_key" name="access_key" type="password" value="''' + str(config.get_config("access_key")) + '''" required="required" maxlength="128"/>
                <label class="config_form_label" for="raw_interval">Raw Data Interval (hours)</label>
                <input class="config_form_input_text" id="raw_interval" name="raw_interval" type="number" value="''' + str(config.get_config("raw_interval")) + '''" required="required" min="0.1" max="8760" step="0.01"/>
                ...
                <input class="config_form_input_number" id="PM1_id" name="PM1_id" type="number" value="''' + str(config.get_config("PM1_id")) + '''" required="required" min="0" max="65535"/>
                <label class="config_form_label" for="PM2_id">PM2 Sensor ID</label>
                <input class="config_form_input_number" id="PM2_id" name="PM2_id" type="number" value="''' + str(config.get_config("PM2_id")) + '''" required="required" min="0" max="65535"/>
                <label class="config_form_label" for="TEMP_id">Temp &amp; Humidity Sensor ID</label>
                <input class="config_form_input_number" id="TEMP_id" name="TEMP_id" type="number" value="''' + str(config.get_config("TEMP_id")) + '''" required="required" min="0" max="65535"/>
                <label class="config_form_label" for="GPS_id">GPS Sensor ID</label>
                <input class="config_form_input_number" id="GPS_id" name="GPS_id" type="number" value="''' + str(config.get_config("GPS_id")) + '''" required="required" min="0" max="65535"/>
                </div>
                <div class="interval_section">
                <label class="config_form_label" for="PM_interval">Interval (m)</label>
                <input class="config_form_input_number" id="PM1_interval" name="PM_interval" type="number" value="''' + str(config.get_config("PM_interval")) + '''" required="required" min="1" max="120" step="0.01"/>
                <label class="config_form_label" for="TEMP_interval">Interval (m)</label>
                <input class="config_form_input_number" id="TEMP_interval" name="TEMP_interval" type="number" value="''' + str(config.get_config("TEMP_interval")) + '''" required="required" min="1" max="120" step="0.01"/>
                <label class="config_form_label" for="GPS_interval">Interval (h)</label>
                <input class="config_form_input_number" id="GPS_interval" name="GPS_interval" type="number" value="''' + str(config.get_config("GPS_interval")) + '''" required="required" min="0.1" max="8760" step="0.01"/>
                </div>
                <br><br>
