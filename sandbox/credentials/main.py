...
wlan = network.WLAN(mode=WLAN.AP, ssid='PetersPy')
#Connect to PetersPy using the passowrd pmsensor
wlan.init(mode=WLAN.AP, ssid='PetersPy', auth=(WLAN.WPA2, 'pmsensor'), channel=1, antenna=WLAN.INT_ANT)
...
# while not wlan.isconnected(): #waiting for wifi to turn on
#     time.sleep_ms(50)

print('Access point turned on as PetersPy')
